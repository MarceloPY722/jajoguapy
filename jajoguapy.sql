...
CREATE TABLE `abastecimientos` (
  ...
  `fecha` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
INSERT INTO `abastecimientos` (`id`, `numero`, `fecha`, `proveedor_id`, `fecha_creacion`) VALUES
(7, 1, '2024-10-29', 5, '2024-11-08 13:40:34'),
(9, 2, '2024-11-13', 6, '2024-11-13 18:00:51'),
(10, 3, '2024-11-30', 7, '2024-11-28 14:26:24'),
(11, 4, '2024-11-30', 7, '2024-11-28 21:59:47');
...
--
-- Dumping data for table `abastecimientos_productos`
--

INSERT INTO `abastecimientos_productos` (`id`, `producto_id`, `abastecimiento_id`, `cantidad`, `fecha_creacion`) VALUES
(7, 20, 9, 12, '2024-11-13 18:01:02'),
(8, 65, 7, 10, '2024-11-15 17:39:45'),
(9, 66, 10, 5, '2024-11-28 14:26:52');
...
INSERT INTO `categorias` (`id`, `nombre`, `descuentos`, `fecha_creacion`) VALUES
(1, 'Celulares', 0, '2024-11-08 13:41:04'),
(3, 'Media Player', 0, '2024-11-08 13:41:04'),
(11, 'Smart TV', 0, '2024-11-08 13:41:04'),
(12, 'Smartwatch', 0, '2024-11-08 13:41:04'),
(13, 'Notebook', 0, '2024-11-08 13:41:04'),
(14, 'Consolas y Accesorios', 0, '2024-11-08 13:41:04'),
(15, 'Juegos', 0.3, '2024-11-08 13:41:04'),
(17, 'Ofertas', 0, '2024-11-08 13:41:04'),
(18, 'Auriculares', 0.25, '2024-11-11 12:32:14'),
(19, 'Router', 0, '2024-11-28 14:19:39');
...
CREATE TABLE `ciudades` (
  `id` int NOT NULL,
  `nombre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(157, '2024-11-28', 55, '2024-11-28 14:47:01'),
(163, '2024-11-28', 59, '2024-11-28 21:34:54'),
(183, '2024-11-29', 49, '2024-11-29 15:14:34');
...
(151, 25, 157, 1, '2024-11-28 14:47:01'),
(157, 65, 163, 3, '2024-11-28 21:34:54'),
(177, 25, 183, 1, '2024-11-29 15:14:34');
...
CREATE TABLE `productos` (
  `id` int NOT NULL,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `precio_compra` float NOT NULL DEFAULT '0',
  `precio_venta` float NOT NULL DEFAULT '0',
  `imagen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cantidad_stock` int DEFAULT NULL,
  `detalles` varchar(10000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `proveedores` (
  `id` int NOT NULL,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `direccion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `correo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `telefono` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `fecha_creacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `proveedores` (`id`, `nombre`, `direccion`, `correo`, `telefono`, `fecha_creacion`) VALUES
(5, 'Samsung Paraguay', 'Azara c/ Peru', 'sansungpy@gmail.com', '0986554765', '2024-11-08 13:40:55'),
(6, 'Apple', 'Exportado', 'apple@gmail.com', '800–692–7753', '2024-11-08 14:29:14'),
(7, 'Routers Paraguay', 'Asuncion', 'marceloariel722@gmail.com', '0971631959', '2024-11-28 14:25:44');
...
CREATE TABLE `usuarios` (
  ...
  `direccion_envio` varchar(250) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
  `imagen` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ciudad_id` int DEFAULT NULL,
  `fecha_creacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `nombre_mascota` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `usuarios` (`id`, `usuario`, `contrasena`, `correo`, `rol`, `nombre`, `apellido`, `telefono`, `direccion_envio`, `imagen`, `ciudad_id`, `fecha_creacion`, `nombre_mascota`) VALUES
(1, 'M722', '81dc9bdb52d04dc20036dbd8313ed055', 'marcelo@gmail.com', 'admin', 'Marcelo Ariel', 'Benitez', 971631936, 'Administrador', 'Screenshot 2024-09-10 084131.png', 12, '2024-11-08 13:38:35', NULL),
(42, 'M783', '81dc9bdb52d04dc20036dbd8313ed055', 'markbenzar722@gmail.com', 'admin', 'Marcelo', '', 971631936, '', 'images (2).jpeg', NULL, '2024-11-08 13:38:35', NULL),
(49, 'Marcelo', '81dc9bdb52d04dc20036dbd8313ed055', 'marceloariel722@gmail.com', 'cliente', 'Marcelo', 'Benitez', 971631936, 'San Martin Casi Bolivar', 'R.jpeg', 12, '2024-11-08 13:38:35', 'Negri'),
(52, 'M888', '81dc9bdb52d04dc20036dbd8313ed055', 'marceloariel7225@gmail.com', 'cliente', 'MarceloZ', 'BenitezZ', 971631936, '', 'HD-wallpaper-perfil-cool-tecnologia.jpg', 15, '2024-11-08 14:16:09', NULL),
(55, 'Ariel', '81dc9bdb52d04dc20036dbd8313ed055', 'arielzarate@gmail.com', 'cliente', 'Ariel Marcelo', 'Benitez', 971598787, 'Asuncion', 'archer_ax11000_-_01-removebg-preview.png', 12, '2024-11-28 14:45:42', 'Mia'),
(56, 'Jaz', '827ccb0eea8a706c4c34a16891f84e7b', 'jaz_oviedo@hotmail.com', 'cliente', 'Jazmin', 'Oviedo ', 982627537, 'San Lorenzo', 'workperch-mR3UqBUU9Ts-unsplash.jpg', 1, '2024-11-28 15:08:49', 'Pupy'),
(57, 'Jazz', '5f3eff882438b387a6f1ad1608b4c44c', 'jazzridis@gmail.com', 'cliente', 'Jazmín', 'Ridis', 972764461, 'Altos', 'IMG-20240621-WA0004.jpg', 4, '2024-11-28 15:15:09', 'Kan'),
(58, 'Carmencita', '6dffa06909764f4a1428fe224d07ef95', 'carmengonzalezmorinigo@gmail.com', 'cliente', 'Carmen', 'Gonzalez ', 985985237, 'Capaiata', '0000001014cnt-2017-01-01_calendario-vacunacion_alta (1).jpg', 1, '2024-11-28 20:15:40', 'Puca'),
(59, 'Matias', '81dc9bdb52d04dc20036dbd8313ed055', 'matias@gmail.com', 'cliente', 'Matias', 'Benitez', 971268229, 'New York', '20240910_202008.jpg', 12, '2024-11-28 21:27:22', 'Negri');
