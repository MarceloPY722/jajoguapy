...
$id = $_SESSION['id'];
$req = $bd->prepare('SELECT u.*, v.nombre AS nomv FROM usuarios u, ciudades v
                      WHERE u.ciudad_id = v.id AND u.id = ?');
$req->execute([$id]);
$data = $req->fetch();
  ...
  <div class="card user-card-full">
      <div class="row m-l-0 m-r-0">
           ...
           <div class="card-block text-center text-white">
                   <div class="m-b-25">
                       <img src="../admin/img/<?=$data['imagen']?>" class="img-responsive rounded-circle border border-light" width="100" height="100" alt="User-Profile-Image">
                   </div>
                   <h6 class="f-w-600"><?=$data['nombre']?> <?=$data['apellido']?></h6>
